          ...
          <div style={styles.bio}>
            <div>
              ...
              <p style={styles.biopara}>
                ...
                supported end-to-end solutions, including building 52 servers
                from scratch, installing hardware, configuring RAID arrays, and
                deploying Windows Server OS, SQL databases, and application
                layers. I also architected and delivered a performance
                monitoring solution for a major UK banking client, including
                report generation and system support.
              </p>
              <p style={styles.biopara}>
